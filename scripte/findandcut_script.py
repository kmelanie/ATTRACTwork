...
### in the following line you have to define the threshold in the function grouper, which sets the number of residues between two flexible residues that will be seen as part of the flexible loop even if them selfes are not within a distance of the before considered distance threshold 
