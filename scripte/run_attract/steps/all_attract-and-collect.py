...
attract='$ATTRACTDIR/attract ./*start.dat $ATTRACTDIR/../attract.par  *bound-and-flexsep.pdb --rest ./*.rest --traj --vmax 100 > '+file+'_final.dat'

for line in open(pdbfile):
    pdblist=line.split()
    endchain=pdblist[0]
    break
collect=['$ATTRACTDIR/collect '+file+'_final.dat']
chain_count=0
